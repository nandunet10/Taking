...
public class CartsController : BaseController
{
    ...
    /// <summary>
    /// Edits an existing cart
    /// </summary>
    /// <param name="request">The cart edit request</param>
    /// <param name="cancellationToken">Cancellation token</param>
    ...
    public async Task<IActionResult> EditCart([FromRoute] Guid cartId, [FromBody] UpdateCartRequest request, CancellationToken cancellationToken)
    {
